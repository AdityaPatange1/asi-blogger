      ...
      <div style={{
        ...
        <div style={{
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
            ...
            <div>
              <span style={{ fontWeight: 700, fontSize: '1.25rem', color: '#171717' }}>ASI</span>
          ...
          <nav style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <Icon size={18} />
                  <span style={{ display: 'none', '@media (min-width: 768px)': { display: 'inline' } } as React.CSSProperties}>{item.label}</span>
                </Link>
              );
            })}
          </nav>
